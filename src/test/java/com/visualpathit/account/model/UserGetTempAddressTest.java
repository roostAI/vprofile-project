...
@Tag("com.visualpathit.account.model.getTempAddress")
public class UserGetTempAddressTest {
	...
	@Test
	@Tag
	('invalid')public void getNullTempAddress() {
		// Arrange
	...
	@Test
	@Tag
	('boundary')public void getEmptyTempAddress() {
		// Arrange
		User user = new User();
		user.setTempAddress("");
		// Act
		String tempAddress = user.getTempAddress();
		// Assert
		assertEquals("", tempAddress,
				"Setting an empty temporary address should return an empty string from getTempAddress() ");
	}
